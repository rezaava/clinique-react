        ...
        <div className="scroll-area">
          <div className="profile-card">
            ...
            <div className="profile-info">
              <div className="profile-name">سارا احمدی</div>
              <div className="profile-phone">۰۹۱۲ ۱۲۳ ۴۵۶۷</div>
              <span className="profile-badge">عضو فعال</span>
            </div>
            ...
            <div className="card-block">
              <div id="infoView">
                <div className="info-row">
                  ...
                  <span className="info-row-v">سارا احمدی</span>
                </div>
                ...
                <div className="info-row">
                  ...
                  <span className="info-row-v">۲۵ خرداد ۱۳۶۹</span>
                </div>
              </div>
